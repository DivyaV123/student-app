...
const inputElClass = computed(() => {
  const base = [
    'px-3 h-9 max-w-full focus:ring focus:outline-none dark:placeholder-gray-400',
    props.inputW,
    computedType.value === 'textarea' ? 'h-20' : 'h-4',
...
<template>
  <div :class="upperWrapperClass">
    ...
    <field-help :help="help" :error="error" :success="success" class="md:mt-1 mt-2 text-xs" />
  </div>
</template>
