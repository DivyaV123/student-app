  ...
  >
    ...
    >
      <p
        ...
        :class="[smallerPadding || icon ? 'px-42' : 'px-4','pb-1','pt-1']"
      >
    ...
    <div
      ...
      :class="[
        ...
        {
          'p-3': !hasTable && !smallerPadding,
          'pt-0 pb-0': hasprofilepadding,
