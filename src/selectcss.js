export const selectClasses = {
    container:
      "relative mx-auto w-full flex items-center justify-end box-border cursor-pointer border border-gray-700 rounded bg-gray-800 text-base leading-snug outline-none",
    ...
    tagsSearch:
      "absolute inset-0 border-0 outline-none focus:ring-0 appearance-none p-0 text-base font-sans box-border w-full bg-gray-800",
    ...
    dropdown:
      "max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full border border-gray-700 -mt-px overflow-y-scroll z-50 bg-gray-800 flex flex-col rounded-b",
    dropdownTop:
    ...
    noOptions: "py-1 px-3 text-gray-600 bg-gray-800 text-left",
