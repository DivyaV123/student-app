...
<template>
  ...
  <div
    class="block w-full rounded-lg shadow-lg">
    <div
      class="border-b border-gray-300 px-2 flex flex-wrap md:justify-between">
      <span class="text-orange-500 text-lg font-semibold">{{ room }}</span>
  ...
  <div
    class="block w-96 rounded-lg shadow-lg bg-gray-700">
    <div
      class="border-b border-gray-300 py-3 text-center font-semibold">
    ...
    <div
      class="flex border-t border-gray-100 py-3 justify-center text-center">
      <BaseLevel mobile>
            <BaseButtons>
              <BaseButton
    ...
    <div
    v-if="joined"
      class="bottom-2 absolute w-full text-center">
